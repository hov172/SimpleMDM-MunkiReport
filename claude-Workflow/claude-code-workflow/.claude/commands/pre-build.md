---
description: Pre-build checklist — run before writing the first line of code on any new app or major feature. Based on Engineering for Vibe Coders (Alan Knox) pre-prototype habits.
argument-hint: "[describe what you are about to build]"
---
