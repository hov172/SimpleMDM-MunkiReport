---
name: prd
description: Create a Product Requirements Document before any build starts. Saves to docs/plans/YYYY-MM-DD-topic-prd.md
---

Based on this context: {user-provided arguments}
