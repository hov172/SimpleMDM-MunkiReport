...
**Status:** Complete. Implemented in code, docs updated, and verified with the module test suite (`66 tests, 126 assertions`).
...
- [x] **Step 2: Run the new test class to verify it fails**
...
- [x] **Step 3: Implement `purgeExpired`**
...
- [x] **Step 4: Run the new test class to verify it passes**
...
- [x] **Step 1: Add the get_config default**
...
- [x] **Step 2: Whitelist the key in save_config**
...
- [x] **Step 4: Call the purge from ingest and report it**
...
- [x] **Step 5: PHP-lint the controller**
...
- [x] **Step 6: Live verification against the container**
...
- [x] **Step 7: Run the full PHPUnit suite (regression)**
...
- [x] **Step 2: Add the populate line**
...
- [x] **Step 4: Live verification (admin page round-trip)**
