...
<div class="col-lg-4 col-md-6">
    <div class="panel panel-default simplemdm-modern-widget simplemdm-status-widget" id="simplemdm-dep-widget">
...
$(document).on('appReady', function(e, lang) {
    ...
    function renderDep() {
        ...
        data.forEach(function(item) {
            var label = depLabels[item.label] || i18n.t('simplemdm.' + item.label) || item.label;
